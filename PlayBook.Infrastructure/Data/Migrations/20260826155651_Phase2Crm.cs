...
{
    /// <inheritdoc />
    public partial class Phase2Crm : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalLimit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmployeeGradeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowExecutions_PlayBooks_PlayBookId",
                        column: x => x.PlayBookId,
                        principalTable: "PlayBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Opportunities_Employees_AssignedEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conditions_PlayBookSteps_StepId",
                        column: x => x.StepId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayBookStepId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowHistories_WorkflowExecutions_WorkflowExecutionId",
                        column: x => x.WorkflowExecutionId,
                        principalTable: "WorkflowExecutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposalNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_Employees_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowTransitions_Conditions_ConditionId",
                        column: x => x.ConditionId,
                        principalTable: "Conditions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WorkflowTransitions_PlayBookSteps_FromStepId",
                        column: x => x.FromStepId,
                        principalTable: "PlayBookSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowTransitions_PlayBookSteps_ToStepId",
                        column: x => x.ToStepId,
                        principalTable: "PlayBookSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowTransitions_PlayBooks_PlayBookId",
                        column: x => x.PlayBookId,
                        principalTable: "PlayBooks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EngagementActivities_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EngagementActivities_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EngagementActivities_Opportunities_OpportunityId",
                        column: x => x.OpportunityId,
                        principalTable: "Opportunities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EngagementActivities_Proposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "Proposals",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EngagementActivities_CustomerId",
                table: "EngagementActivities",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_EngagementActivities_EmployeeId",
                table: "EngagementActivities",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EngagementActivities_OpportunityId",
                table: "EngagementActivities",
                column: "OpportunityId");

            migrationBuilder.CreateIndex(
                name: "IX_EngagementActivities_ProposalId",
                table: "EngagementActivities",
                column: "ProposalId");

            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_AssignedEmployeeId",
                table: "Opportunities",
                column: "AssignedEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Opportunities_CustomerId_Status",
                table: "Opportunities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proposals_CreatedByEmployeeId",
                table: "Proposals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proposals_OpportunityId_Status",
                table: "Proposals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowExecutions_PlayBookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistories_WorkflowExecutionId",
                table: "WorkflowHistories",
                column: "WorkflowExecutionId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowTransitions_ConditionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowTransitions_PlayBookId",
                table: "WorkflowTransitions",
                column: "PlayBookId");
