...
namespace PlayBook.Data.Migrations
{
    ...
    [Migration("20260827185321_VoucherPricingAndProposalRevisions")]
    partial class VoucherPricingAndProposalRevisions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlayBook.Domain.EngagementActivity", b =>
                {
                    ...
                    b.Property<Guid?>("RenewalReminderId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PlayBook.Domain.RenewalReminder", b =>
                {
                    ...
                    b.HasIndex("SubscriptionId", "OffsetDays")
                        .IsUnique();
            ...
            modelBuilder.Entity("PlayBook.Domain.EngagementActivity", b =>
                {
                    ...
                    b.HasOne("PlayBook.Domain.RenewalReminder", "RenewalReminder")
                        .WithMany("Activities")
                        .HasForeignKey("RenewalReminderId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("PlayBook.Domain.Subscription", "Subscription")
                        .WithMany()
